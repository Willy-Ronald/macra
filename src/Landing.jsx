      ...
      <section style={{padding:"80px 20px",maxWidth:1020,margin:"0 auto"}}>
        ...
        <div style={{display:"flex",gap:14,justifyContent:"center",flexWrap:"wrap"}}>
          {[
            ...
            {tier:"Pro Monthly",price:"$4.99",per:"/mo",desc:"For serious trackers",features:["Everything in Free","Unlimited AI meal plans","Smart grocery lists","Household mode","Meal prep & batch cooking","Weekly macro trends"],cta:"Start 7-Day Free Trial",ctaStyle:{border:"none",background:a,color:bg,boxShadow:"0 4px 16px rgba(200,184,138,0.15)"},highlight:true,badge:"POPULAR"},
            {tier:"Pro Annual",price:"$34.99",per:"/yr",desc:"Best value — $2.92/mo",features:["Everything in Pro Monthly","Priority AI generation","Early access to new features","Lock in price forever"],cta:"Start 7-Day Free Trial",ctaStyle:{border:"1px solid "+a,color:a,background:"transparent"},highlight:false,save:"SAVE 42%"},
          ].map((p,i)=>
